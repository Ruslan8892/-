...
const handleSubmit = async (e) => {
    e.preventDefault();
    try { const { data } = await axios.post("http://localhost:5000/api/login", { email, password });
...
return (
    <form onSubmit={handleSubmit} className="max-w-sm mx-auto p-4"> 
        ...
        <button className="bg-blue-500 text-white p-2 w-full" type="submit">Ввійти</button> 
    </form> 
    ); 
}; 
